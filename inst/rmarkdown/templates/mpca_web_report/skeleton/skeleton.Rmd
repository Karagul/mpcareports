...
Explore what lives in DELTA on the [RAINIER pages](http://rainier/documentation/DataDictionary/DELTAW/index.html).

Facility locations were pulled from MPCA's TEMPO database. You can use the `mpcadb` package to access TEMPO.
...
ai_names <- get_ai(ai = c(1:4, 56, 878), keep_alt_names = T)
...
# A map to guide you
```{r full-map, fig.width=10, fig.height=5, fig.fullwidth=T, fig.cap="**Fig 1.**  Federally recognized tribal areas \t\n _Ref. MPCA Geocommons..._", warning=F, message=F}
...
# Collapsible or drop-down content
