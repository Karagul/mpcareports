...
date:  'Published `r lubridate::today()`'
...
This document was written and created with R Markdown, a flexible text format that provides easy export to a variety of formats such as PDFs, Word docs, PowerPoint, and Web sites. Here are a few examples of writing in R Markdown.

## Add a link

To add a link in your text use the format:
...
You can insert an image into your document with the format:
...
>
> Here's how to make a tiny turtle by setting the image to only extend 25% across the available space:
>
...
More great Markdown features —like adding sortable tables and maps— are shown below.
