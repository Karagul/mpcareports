...
>
> To size images in PDF documents, you can add `{out.width="85%"}` to an R chunk's options. You then use the `include_graphics()` function to add an image with the designated width.
>
> Here's how to show a giant turtle by setting the image width extend 85% across the available space:
> 
